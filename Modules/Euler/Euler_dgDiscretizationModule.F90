...
!!$    !$ACC PARALLEL LOOP SEQ &
    ...
    !$ACC          EigVals_L, EigVals_R, uPF_L, uPF_R,  &
    !$ACC          AlphaMns, AlphaPls, AlphaMdl ) &
...
!!$        CALL TimersStart_Euler( Timer_Euler_ComputePrimitive )
        CALL ComputePrimitive_Euler &
               ( uCF_L(iNodeX_X1,iCF_D ,iX2,iX3,iX1),     &
                 ...
                 G_F(iNodeX_X1,iGF_Gm_dd_11,iX2,iX3,iX1), &
                 G_F(iNodeX_X1,iGF_Gm_dd_22,iX2,iX3,iX1), &
                 G_F(iNodeX_X1,iGF_Gm_dd_33,iX2,iX3,iX1), iErr)
...
!        PRINT*, "(D,V1,V2,V3,E,Ne)_L, P_L, Cs_L = ", &
!          uPF_L(iPF_D), uPF_L(iPF_V1), uPF_L(iPF_V3), uPF_L(iPF_V3), uPF_L(iPF_E), uPF_L(iPF_Ne), &
!          P_L, Cs_L
!        PRINT*, "Flux_X1_L = ", &
!          Flux_X1_L(iCF_D), Flux_X1_L(iCF_S1), Flux_X1_L(iCF_S2), Flux_X1_L(iCF_S3), &
!          Flux_X1_L(iCF_E), Flux_X1_L(iCF_Ne)
!#endif
...
!#ifdef THORNADO_DEBUG_EULER
!        PRINT*, "(D,V1,V2,V3,E,Ne)_R, P_R, Cs_R = ", &
!          uPF_R(iPF_D), uPF_R(iPF_V1), uPF_R(iPF_V3), uPF_R(iPF_V3), uPF_R(iPF_E), uPF_R(iPF_Ne), &
!          P_R, Cs_R
!        PRINT*, "Flux_X1_R = ", &
!          Flux_X1_R(iCF_D), Flux_X1_R(iCF_S1), Flux_X1_R(iCF_S2), Flux_X1_R(iCF_S3), &
!          Flux_X1_R(iCF_E), Flux_X1_R(iCF_Ne)
!#endif
...
!!$        CALL TimersStop_Euler( Timer_Euler_NumericalFlux )
    ...
    IF( iErr .EQ. -1 ) STOP 'Surface term (X1)'
...
!!$        CALL TimersStart_Euler( Timer_Euler_ComputePrimitive )
        CALL ComputePrimitive_Euler &
               ( uCF_K(iNodeX,iCF_D ,iX2,iX3,iX1),     &
                 ...
                 G_K(iNodeX,iGF_Gm_dd_33,iX2,iX3,iX1), iErr )
!!$        CALL TimersStop_Euler( Timer_Euler_ComputePrimitive )
    ...
    IF( iErr .EQ. -1 ) STOP 'Volume term (X1)'
...
!!$        CALL TimersStart_Euler( Timer_Euler_ComputePrimitive )
        CALL ComputePrimitive_Euler &
               ( uCF_L(iNodeX_X2,iCF_D ,iX1,iX3,iX2),     &
                 ...
                 G_F(iNodeX_X2,iGF_Gm_dd_11,iX1,iX3,iX2), &
                 G_F(iNodeX_X2,iGF_Gm_dd_22,iX1,iX3,iX2), &
                 G_F(iNodeX_X2,iGF_Gm_dd_33,iX1,iX3,iX2), iErr )
!!$        CALL TimersStop_Euler( Timer_Euler_ComputePrimitive )
...
!!$        CALL TimersStop_Euler( Timer_Euler_NumericalFlux )
    ...
    IF( iErr .EQ. -1 ) STOP 'Surface term (X2)'
...
!!$        CALL TimersStart_Euler( Timer_Euler_ComputePrimitive )
        CALL ComputePrimitive_Euler &
               ( uCF_K(iNodeX,iCF_D ,iX1,iX3,iX2),     &
                 ...
                 G_K(iNodeX,iGF_Gm_dd_33,iX1,iX3,iX2), iErr )
!!$        CALL TimersStop_Euler( Timer_Euler_ComputePrimitive )
    ...
    IF( iErr .EQ. -1 ) STOP 'Volume term (X2)'
  ...
  SUBROUTINE ComputeIncrement_Divergence_X3 &
    ...
    INTEGER  :: iNodeX, iNodeX_X3, iX1, iX2, iX3, iCF, iGF, iErr
    REAL(DP) :: Alpha, AlphaMns, AlphaPls, AlphaMdl
    REAL(DP) :: uPF_L(nPF), uPF_R(nPF), uPF_K(nPF)
...
!!$        CALL TimersStart_Euler( Timer_Euler_ComputePrimitive )
        CALL ComputePrimitive_Euler &
               ( uCF_L(iNodeX_X3,iCF_D ,iX1,iX2,iX3),     &
                 ...
                 G_F(iNodeX_X3,iGF_Gm_dd_11,iX1,iX2,iX3), &
                 G_F(iNodeX_X3,iGF_Gm_dd_22,iX1,iX2,iX3), &
                 G_F(iNodeX_X3,iGF_Gm_dd_33,iX1,iX2,iX3), iErr )
!!$        CALL TimersStop_Euler( Timer_Euler_ComputePrimitive )
...
!!$        CALL TimersStop_Euler( Timer_Euler_NumericalFlux )
    ...
    IF( iErr .EQ. -1 ) STOP 'Surface term (X3)'
...
!!$        CALL TimersStart_Euler( Timer_Euler_ComputePrimitive )
        CALL ComputePrimitive_Euler &
               ( uCF_K(iNodeX,iCF_D ,iX1,iX2,iX3),     &
                 ...
                 G_K(iNodeX,iGF_Gm_dd_33,iX1,iX2,iX3), iErr )
!!$        CALL TimersStop_Euler( Timer_Euler_ComputePrimitive )
    ...
    IF( iErr .EQ. -1 ) STOP 'Volume term (X3)'
